...
<div id="show-car" class="content scaffold-show" role="main">
    ...
    <ol class="property-list car">
        ...
        <g:if test="${carInstance?.trim}">
            <li class="fieldcontain">
                <span id="trim-label" class="property-label"><g:message code="car.trim.label" default="Trim"/></span>

                <span class="property-value" aria-labelledby="trim-label"><g:fieldValue bean="${carInstance}"
                                                                                        field="trim"/></span>
        ...
        <g:if test="${carInstance?.make}">
            <li class="fieldcontain">
                ...
                <span class="property-value" aria-labelledby="make-label"><g:fieldValue bean="${carInstance}"
                                                                                        field="make"/></span>
        ...
        <g:if test="${carInstance?.model}">
            <li class="fieldcontain">
                ...
                <span class="property-value" aria-labelledby="model-label"><g:fieldValue bean="${carInstance}"
                                                                                         field="model"/></span>
        ...
        <g:if test="${carInstance?.user}">
            <li class="fieldcontain">
                ...
                <span class="property-value" aria-labelledby="user-label"><g:link controller="user" action="show"
                                                                                  id="${carInstance?.user?.id}">${carInstance?.user?.encodeAsHTML()}</g:link></span>
        ...
        <g:if test="${carInstance?.year}">
            <li class="fieldcontain">
                ...
                <span class="property-value" aria-labelledby="year-label"><g:fieldValue bean="${carInstance}"
                                                                                        field="year"/></span>
